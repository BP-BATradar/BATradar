...
from .features import FeatureConfig, extract_log_mel_from_path, load_mono_audio, compute_log_mel_spectrogram
...
def main() -> None:
    ...
    parser.add_argument("--model-path", default="classification/models/cnn_model.joblib", type=str)
