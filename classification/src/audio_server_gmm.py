...
from .features import FeatureConfig, extract_features_from_path, load_mono_audio, compute_mfcc_feature_vector
...
def main() -> None:
    ...
    parser.add_argument("--model-path", default="classification/models/gmm_model.joblib", type=str)
