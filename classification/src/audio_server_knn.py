...
from .features import FeatureConfig, load_mono_audio, compute_mfcc_feature_vector
...
def main() -> None:
    ...
    parser.add_argument("--model-path", default="classification/models/knn_model.joblib", type=str)
